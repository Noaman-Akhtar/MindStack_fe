  ...
  function handleStart() {
    ...
    const u = uploadManyWithProgress(pendingFiles, {
      ...
      onAllComplete: (finalItems) => {
        ...
        const canceled = finalItems.filter(
          (f) => f.status === "canceled"
        ).length;
        const msgParts = [];
  ...
  return (
    <div className="border rounded p-6 space-y-4 bg-white">
      <div className="flex items-center justify-between">
        <label className="rounded-sm text-sm font-medium cursor-pointer text-gray-700">
        ...
        <button
          ...
          className="px-2  py-1 rounded text-xs bg-blue-600 text-white disabled:opacity-50"
        >
